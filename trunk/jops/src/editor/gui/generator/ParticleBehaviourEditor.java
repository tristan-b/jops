...
public class ParticleBehaviourEditor extends SimpleEditor implements
		ActionListener, ValueListChangedListener {
...
/*
		...
		if (source == chooser.getSizeButton()) {
			...
			vgui.setValueList(null,particleBehaviour.getSize(), 100f, 0f, 20f,
			...
			vgui.setListener(this);
			vgui.setActive(true);
			vgui.setValueList(null,particleBehaviour.getSpeed(), 100f, -20f, 20f,
					0.01f, 0.01f, 0f, 2.5f, 5f);
			destination.add(vgui);
			...
			vgui.setValueList(new ColorConverter(),particleBehaviour.getAlpha(), 1f, 0f, 255f, 1f,
					1f, 255f, 100f, 255f);
			destination.add(vgui);
			...
			vgui.setValueList(new AngleRadiansConverter(),particleBehaviour.getSpin(), 1f, -3600f, 3600f, 1f,
					1f, 0f, 1800f, 3600f);
			destination.add(vgui);
			...
			vgui.setValueList(new AngleRadiansConverter(),particleBehaviour.getAngle(),1f, -360f, 360f,
					1f, 1f, 0f, 90f, 180f);
			destination.add(vgui);
			...
			vgui.setValueList(new AngleRadiansConverter(),particleBehaviour.getParticleAngleH(),1f, -360f,
			...
			vgui.setValueList(new AngleRadiansConverter(),particleBehaviour.getParticleAngleV(), 1f, -360f,
					360f, 1f, 1f, 0f, 90f, 180f);
			destination.add(vgui);
			...
			vgui.setValueList(new AngleRadiansConverter(),particleBehaviour.getParticleSpinH(), 1f, -3600f,
			...
			vgui.setValueList(new AngleRadiansConverter(),particleBehaviour.getParticleSpinV(), 1f, -3600f,
					3600f, 1f, 1f, 0f, 1800f, 3600f);
			destination.add(vgui);
			...
			vgui.setValueList(null,particleBehaviour.getWidth(), 100f, 0f, 20f,
			...
			vgui.setValueList(null,particleBehaviour.getHeight(),  100f, 0f, 20f,
					0.01f, 0.01f, 10f, 2.5f, 5f);
			destination.add(vgui);
			...
			vgui.setValueList(null,particleBehaviour.getTexWidth(), 100f, 0f, 5f,
			...
			vgui.setValueList(null,particleBehaviour.getTexHeight(), 100f, 0f, 5f,
					0.01f, 0.01f, 10f, 0.5f, 1f);
			destination.add(vgui);
			...
			vgui.setValueList(null,particleBehaviour.getMass(), 100f, 0f, 20f,
					0.01f, 0.01f, 0.1f, 5f, 10f);
			destination.add(vgui);
		}
