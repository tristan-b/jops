...
public class GenericValueGUI extends SizeablePanel implements ActionListener,
		ChangeListener {
	...
	public GenericValueGUI(IValueConverter converter2, GenericValue v) {
		...
		// setMaximumSize(new Dimension(470, 60));
		...
		if (temp instanceof Float) {
			...
			throw new RuntimeException(
					"Can't Find a proper Indicator !!! Class Not Recognized !!! No Known Indicators !!!");
...
//		else
//			valueInd.setValue(converter.fromInternalToExternal(temp));
	}
	...
	public void refresh() {
		...
		if (valueInd != null)
			...
			setValue(gvalue.value);

		// valueInd.setValue(gvalue.value);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == remove) {
			// TODO show a modeal popup to confirm deletion
			if (editActionListener != null)
				editActionListener.remove(this);
		} else if (e.getSource() == add) {
			if (editActionListener != null)
				editActionListener.addNew(this);
		} else {
...
//			else
//				gvalue.setValue(converter.fromExternalToInternal(valueInd
//						.getValue()));
		}

		if (editActionListener != null)
			editActionListener.changed(this);
	}

	public void setArgs(Object... args) {

		if (valueInd != null)
			valueInd.setArgs(args);
	}
